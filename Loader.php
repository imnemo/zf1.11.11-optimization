...
//     	var_dump($class);
        ...
        /**
         * 限制$dir为string类型：dir1(:dir2)(:dir3)...
         * 或者array类型array(dir1, dir2, dir3, ...)
         */
        ...
        /**
         * 支持$className为使用命名空间的形式，然后将命名空间提出来作为dir
         */
    ...
    public static function loadFile($filename, $dirs = null, $once = false)
    {
         ...
         * 把提供的$dir加到include_path里面去，然后直接包含文件
         */
        $incPath = false;
         ...
         * 既然加载类文件直接判断了类或者接口是否存在，因此就不需使用once了，提升些效率
         */
        if ($once) {
    ...
    public static function explodeIncludePath($path = null)
    {
        ...
        /**
         * '#:(?!//)#' 即 '/:(?!//)/'， 匹配的是：，除了://的情况
         * 根据下面的注释，*nix系统中，include_path里有可能出现a stream schema的情况，即://...，这种不当做
         * PATH_SEPARATOR
         */
        if (PATH_SEPARATOR == ':') {
